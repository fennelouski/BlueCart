...
open class DOFavoriteButton: UIButton {
    ...
    var deselectedAlpha: CGFloat = 0.3
    @IBInspectable open var image: UIImage! {
        didSet {
            createLayers(image: image)
        }
    }
    @IBInspectable open var imageColorOn: UIColor! = UIColor(red: 255/255, green: 51/255, blue: 51/255, alpha: 1.0) {
        didSet {
            if (isSelected) {
    ...
    @IBInspectable open var circleColor: UIColor! = UIColor(red: 255/255, green: 51/255, blue: 51/255, alpha: 1.0) {
        didSet {
    ...
    override open var isSelected : Bool {
        didSet {
            ...
            alpha = isSelected ? selectedAlpha : deselectedAlpha
        }
    }
